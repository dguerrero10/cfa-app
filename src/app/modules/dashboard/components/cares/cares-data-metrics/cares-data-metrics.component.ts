...
@Component({
  selector: 'app-cares-data-metrics',
  templateUrl: './cares-data-metrics.component.html',
  styleUrls: ['./cares-data-metrics.component.scss']
})
export class CaresDataMetricsComponent implements OnInit {
