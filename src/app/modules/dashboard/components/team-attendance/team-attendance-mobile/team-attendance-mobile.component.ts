...
@Component({
  selector: 'app-team-attendance-mobile',
  templateUrl: './team-attendance-mobile.component.html',
  styleUrls: ['./team-attendance-mobile.component.scss']
})
export class TeamAttendanceMobileComponent implements OnInit {
